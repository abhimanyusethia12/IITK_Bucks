...
class block:
    ...
    def block_from_bytearray(self,bytestream):
        ...
        parent_block_hash = (hex(int.from_bytes(bytestream[4:36],'big'))[2:]).zfill(64)
        block_body_hash = (hex(int.from_bytes(bytestream[36:68],'big'))[2:]).zfill(64)
        target_value = (hex(int.from_bytes(bytestream[68:100],'big'))[2:]).zfill(64)
